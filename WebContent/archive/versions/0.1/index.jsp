...
<head>
    ...
    <script src="http://api.map.baidu.com/api?v=2.0&ak=QRkIhU6mXdkPxucPoLWcoHbe"></script>
    <!--
...
<div class="mainbody">
    ...
    <div class="top-list">
        <div><img class="tab-icon" src="../../../i/icons/bus-exchange-white.png" width="32">公交换乘<input type="hidden"
                                                                                                       value="0"/></div>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <input class="ben-text" type="text" name="start" value="" maxlength="100"
                                       autocomplete="off"/>

                                <div class="ben-texthint">
                                    <ul>
                                        <li class="ben-texthint-spec"><a>关闭</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="ben-text" type="text" name="dest" value="" maxlength="100"
                                       autocomplete="off"/>
                        ...
                        <tr>
                            <td colspan="2"><input class="ben-button" type="submit" name="bus-exchange-submit"
                                                   value="走！"/></td>
                        </tr>
                    </table>
                </div>
            ...
            <form class="ben-form" name="bus-oneclickhome" action="search.jsp" method="post">
                ...
                <table>
                    <tr>
                        ...
                        <td><input class="ben-text" type="text" name="currentLoc" value="" maxlength="100"
                                   autocomplete="off"/></td>
                    </tr>
                    <tr>
                        <td style="text-align: left;"><label>家的位置</label></td>
                        <td><input class="ben-text" type="text" name="homeLoc" value="" maxlength="100"
                                   autocomplete="off"/></td>
                    <tr>
...
<div class="map_wrapper __temp">
                ...
                <ul id="_sidebar-list">
                    <li>
                        <table>
                            <tr>
                                <td>
                                    <div class="item-index _vwrap">
                                        <div class="_vcontent">24</div>
                                    </div>
                                </td>
                                <td width="100%">
    ...
    <div id="_map" style="width: 500px; height: 500px;"></div>
